...
vgg19_download_link: str = "http://www.vlfeat.org/matconvnet/models/imagenet-vgg-verydeep-19.mat"
vgg19_file_name: str = "imagenet-vgg-verydeep-19.mat"


def vgg19_download(file_name: str, expected_bytes: int = 534904783):
    ...
    if file_stat.st_size == expected_bytes:
        ...
        raise ValueError("[-] File " + file_name + " might be corrupted :(")
...
def pool2d_layer(input_, pool: str = "avg"):
